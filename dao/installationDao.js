...
class InstallationDao {
    ...
    findByNomVille(ville){
        const sqlRequest = "SELECT * FROM installation WHERE nom_de_la_commune LIKE  $ville";
    ...
    findByNomInstallation(nom){
        const sqlRequest = "SELECT * FROM installation WHERE nom_usuel_de_l_installation LIKE  $nom";
